...
if($error == $ERROR_NO_ERROR && $input_file_type == "pdf") {
	...
	if ($retval != 0) {
		...
		$faxout_command = $script_local_path . "/faxout.awk " . $clean_dest . " " . $input_file_tif . " " . $faxid . " " . "'".$callerid."'" . " " . "'".$faxHeader."'" ." ". "'".$username."'"." ". "'".$user_email."'". " try=1";
...
//echo "<pre>";print_r($faxout_output);echo  $retval;exit;
		$fax_op=explode(":",$faxout_output[21]);
